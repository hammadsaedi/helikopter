...
func init() {
	...
	register(&Theme{
		Name: "mono",
		Desc: "greyscale, for terminals and purists",
		Mat: build(mats{
			art.MatHull:     {198, 198, 198},
			art.MatBelly:    {96, 96, 96},
			art.MatCanopy:   {132, 132, 132},
			art.MatFrame:    {52, 52, 52},
			art.MatEngine:   {168, 168, 168},
			art.MatExhaust:  {248, 248, 248},
			art.MatFin:      {182, 182, 182},
			art.MatSkid:     {88, 88, 88},
			art.MatRotor:    {226, 226, 226},
			art.MatHub:      {120, 120, 120},
			art.MatNavRed:   {236, 236, 236},
			art.MatNavGreen: {236, 236, 236},
			art.MatBeacon:   {255, 255, 255},
		}),
		SkyTop: RGB{14, 14, 14}, SkyHorizon: RGB{58, 58, 58},
		OrbVisible: false,
		Cloud:      RGB{74, 74, 74}, CloudShade: RGB{40, 40, 40},
		Ridge: RGB{46, 46, 46}, Hills: RGB{32, 32, 32}, Ground: RGB{20, 20, 20},
		Star: RGB{220, 220, 220}, Stars: false,
		Wash:   RGB{110, 110, 110},
